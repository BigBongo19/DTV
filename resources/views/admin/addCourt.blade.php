...
<head>
    ...
    <title>DTV Admin | Baan toevoegen</title>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Baan toevoegen</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/admin/home">Home</a></li>
                            <li class="breadcrumb-item active">Baan toevoegen</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
            ...
            <div class="container-fluid">
                <form method="POST" style="max-width: 1200px">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="inputName" name="courtName">
                    </div>
