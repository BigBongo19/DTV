                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    @foreach($reservations as $reservation)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="editReservation/{{$reservation->id}}" class="mr-2 ml-2"><i class="fas fa-edit"></i></a>

                                                <form method="POST" action="/admin/deleteReservation/{{$reservation->id}}" accept-charset="UTF-8" style="display: inline;"><input name="_method" type="hidden">
                                                    @csrf
                                                    @method('delete')
                                                    <input type="hidden" name="id" value="{{$reservation->id}}">
                                                    <span onclick="deleteEntity(this)"><i class="fas fa-trash" style="color: red"></i><input type="submit"></span>
                                                </form>
                                            </td>
                                        </tr>
                                        @php($i++)
